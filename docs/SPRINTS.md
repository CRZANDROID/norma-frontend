...
Plan canónico: backend `docs/SPRINTS.md` + `docs/HANDOFF.md`.  
Briefs: backend `docs/FRONTEND-ADMIN.md`, `docs/FRONTEND-TRACKING.md`, `docs/FRONTEND-ALERTAS.md`.

El piloto son **10 semanas** (S1–S10).
